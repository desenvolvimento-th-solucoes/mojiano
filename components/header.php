    ...
    <header class="navbar">
        <div class="max-width">
            <nav class="navbar-menu">
                <a href="#" aria-label="Voltar ao início"> <img id="header-image" src="./assets/image/logo.png"> </a>
                <ul>
                    <div class="navbar-menu-default">
                    ...
                    <li>
                        <a href="https://api.whatsapp.com/send/?phone=5519971127931&text&type=phone_number&app_absent=0">
                            <button style="display: flex; align-items: center; gap: 10px;" class="whatsapp-button md-button">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
